    ...
    return (
        <div className={`py-20 lg:py-28`}>
            <div className={`container`}>
                <SectionHeader title={`A Glimpse Into My World`} eyebrow={`About Me`}
                ...
                <div className={`mt-20 flex flex-col gap-8`}>
                    ...
                    <div className={`grid grid-cols-1 gap-8 md:grid-cols-5 lg:grid-cols-3`}>
                        ...
                        <Card className={`h-[320px p-0] md:col-span-2 lg:col-span-1`}>
                            ...
                            <div
                                className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full after:content-[''] after:absolute after:inset-0 after:outline after:outline-2 after:-outline-offset-2 after:rounded-full after:outline-gray-950/30`}>
